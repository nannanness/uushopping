...
public class Order {
    ...
    public Order(int userId, String orderDate, String paymentDate, String deliveryDate, String orderStatus, int orderAmount, int harvestAddressId, String ordersExpressDelivery, int payId, int orderCommodityId) {
        this.userId = userId;
    ...
    public Order(int orderId, int userId, String orderDate, String paymentDate, String deliveryDate, String orderStatus, int orderAmount, int harvestAddressId, String ordersExpressDelivery, int payId, int orderCommodityId) {
