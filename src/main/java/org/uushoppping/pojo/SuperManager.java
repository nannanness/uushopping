...
public class SuperManager {
    ...
    public SuperManager(String managerName, String managerPassword, String managerSex, int managerAge, int managerPhone, String managerEmail, int managerQQ, String managerDate) {
    ...
    public SuperManager(int managerId, String managerName, String managerPassword, String managerSex, int managerAge, int managerPhone, String managerEmail, int managerQQ, String managerDate) {
