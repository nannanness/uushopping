  ...
  <div class="brand_info clearfix">
   ...
   <form>
    ...
    <div class="brand_logo">
      <img src="/resources/products/black/yinglian.jpg" width="120px" height="60px">
      <p class="name">中国银联</p>
    </div>
   </form>
   </div>
      ...
      <div class="bank_list clearfix">
        <ul class="bank_logo clearfix">
         <li>
          ...
          <label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="/resources/products/black/black1.png" width="160px;"/></span></label>
         </li>
         <li>
          <div class="delete_bank"><a href="javascript:ovid()"  onclick="bank_del(this,'124')"class="fa fa-remove"></a></div>
          <label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="/resources/products/black/black2.png" width="160px;"/></span></label>
         </li>
         <li>
          <div class="delete_bank"><a href="javascript:ovid()"  onclick="bank_del(this,'125')"class="fa fa-remove"></a></div>
          <label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="/resources/products/black/black3.png" width="160px;"/></span></label>
         </li>
         <li>
          <div class="delete_bank"><a href="javascript:ovid()"  onclick="bank_del(this,'126')"class="fa fa-remove"></a></div>
          <label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="/resources/products/black/black4.png" width="160px;"/></span></label>
         </li>
         <li>
         ...
         <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="/resources/products/black/black6.png" width="160px;"/></span></label></li>
         <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="/resources/products/black/black7.png" width="160px;"/></span></label></li>
         <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="/resources/products/black/black8.png" width="160px;"/></span></label></li>
         <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="/resources/products/black/black9.png" width="160px;"/></span></label></li>
         <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="/resources/products/black/black10.png" width="160px;"/></span></label></li>
         <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="/resources/products/black/black11.png" width="160px;"/></span></label></li>
         <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="/resources/products/black/black12.png" width="160px;"/></span></label></li>
         <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="/resources/products/black/black13.png" width="160px;"/></span></label></li>
         <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="/resources/products/black/black14.png" width="160px;"/></span></label></li>
         <li><label><input name="form-field-checkbox" type="checkbox" class="ace"><span class="lbl"><img src="/resources/products/black/black15.png" width="160px;"/></span></label></li>
        </ul>
