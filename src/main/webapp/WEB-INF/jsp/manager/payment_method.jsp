     ...
     <div class="type_title">支付方式</div>
      <div class="defray_content clearfix">
       ...
       <li class="defray_name">支付宝</li>
        <li class="name_logo"><img src="/resources/products/black/zhifb.jpg"  width="100%" height="150px;" /> </li>
       ...
       <li class="defray_name">微信支付</li>
        <li class="name_logo"><img src="/resources/products/black/weixin.jpg"  width="100%" height="150px;" /> </li>
