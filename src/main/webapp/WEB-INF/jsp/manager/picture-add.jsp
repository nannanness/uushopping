...
<link href="/resources/Widget/webuploader/0.1.5/webuploader.css" rel="stylesheet" type="text/css" />
   ...
   <div class="type_title">添加商品</div>
	<form action="" method="post" class="form form-horizontal" id="form-article-add">
		...
		<div class=" clearfix cl">
			...
			<div class="Add_p_s">
            <label class="form-label col-2">商品id：</label>
            ...
            <div class="Add_p_s">
                <label class="form-label col-2">商品款式：</label>	
                <div class="formControls col-2"><input type="text" class="input-text" value="" placeholder=""  name="" >kg</div>
               </div>
             <div class="Add_p_s">
...
<script type="text/javascript" src="/resources/Widget/My97DatePicker/WdatePicker.js"></script>
<script type="text/javascript" src="/resources/Widget/icheck/jquery.icheck.min.js"></script>
...
<script type="text/javascript" src="/resources/Widget/webuploader/0.1.5/webuploader.min.js"></script>
<script type="text/javascript" src="/resources/Widget/ueditor/1.4.3/ueditor.config.js"></script>
<script type="text/javascript" src="/resources/Widget/ueditor/1.4.3/ueditor.all.min.js"> </script>
<script type="text/javascript" src="/resources/Widget/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
<script src="/resources/js/lrtk.js" type="text/javascript" ></script>
<script type="/resources/text/javascript" src="js/H-ui.js"></script>
<script type="/resources/text/javascript" src="js/H-ui.admin.js"></script>
<script>
$(function() { 
	$("#add_picture").fix({
		float : 'left',
