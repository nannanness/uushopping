        ...
        <div class="order_list_style" id="order_list_style">
            ...
            <div class="Orderform_list">
                <table class="table table-striped table-bordered table-hover" id="sample-table">
                    ...
                    <tbody>
                    <c:forEach var="ordersBusinessList" items="${OrdersBusiness}">
                        <tr>
                            <td><label><input type="checkbox" class="ace"><span class="lbl"></span></label></td>
                            <td>${ordersBusinessList.orderId}</td>
                            <td class="order_product_name">${ordersBusinessList.orderDate}</td>
                            <td>${ordersBusinessList.orderAmount}</td>
                            <td>${ordersBusinessList.paymentDate}</td>
                            <td>${ordersBusinessList.ordersExpressDelivery}</td>
                            <td>${ordersBusinessList.harvestAddressId}</td>
                            <td class="td-status"><span class="label label-success radius">${ordersBusinessList.orderStatus}</span></td>
                            <td></td>
                            <td>
                                <a onClick="Delivery_stop(this,'${ordersBusinessList.orderId}')"  href="javascript:;" title="发货"  class="btn btn-xs btn-success"><i class="fa fa-cubes bigger-120"></i></a>
                                <a title="订单详细"  href="/pageJump/order_detailed-business.do"  class="btn btn-xs btn-info order_detailed" ><i class="fa fa-list bigger-120"></i></a>
                                <a title="删除" href="javascript:;"  onclick="Order_form_del(this,'${ordersBusinessList.orderId}')" class="btn btn-xs btn-warning" ><i class="fa fa-trash  bigger-120"></i></a>
                            </td>
                        </tr>
                    </c:forEach>
                    <tr>
...
<script>
            ...
            yes: function(index, layero){
                ...
                if($('#form-field-1').val()==""){
                    ...
                    layer.confirm('提交成功！',function(index){
                        ...
                        $(obj).remove();
                        window.location.href="/shopController/updateOrderStatus.do?orderStatus=已发货&ordersExpressDezlivery="+options.text()+"&orderId="+id;
    ...
    function Order_form_del(obj,id){
        layer.confirm('确认要删除吗？',function(index){
            ...
            window.location.href="/shopController/delete.do?orderId="+id;
