 ...
 <div id="products_style">
    <div class="search_style">
      ...
      <ul class="search_content clearfix">
       <li><label class="l_f">商品名称</label><input name="" type="text"  class="text_add" placeholder="输入品牌名称"  style=" width:250px"/></li>
     ...
     <div class="border clearfix">
       <span class="l_f">
        <a href="/pageJump/picture-add-business.do" title="添加商品" class="btn btn-warning Order_form"><i class="icon-plus"></i>添加商品</a>
