...
<div class="margin clearfix">
 ...
 <div class="border clearfix">
     ...
     <div class="refund_list">
        ...
        <tbody>
        <c:forEach items="${RefundBusiness}" var="RefundBusinessList">
         <tr>
           <td><label><input type="checkbox" class="ace"><span class="lbl"></span></label></td>
     <td>${RefundBusinessList.orderId}</td>
     <td class="order_product_name">
      <a href="#">${RefundBusinessList.orderDate}</a>
     </td>
     <td>${RefundBusinessList.orderAmount}</td>
     <td>${RefundBusinessList.paymentDate}</td>
     <td>${RefundBusinessList.orderAmount}</td>
     <td>${RefundBusinessList.harvestAddressId}</td>
     ...
     <a title="退款订单详细"  href="/pageJump/Refund_detailed-business.do"  class="btn btn-xs btn-info Refund_detailed" >详细</a>
     <a title="删除" href="javascript:;"  onclick="Order_form_del(this,'${RefundBusinessList.orderId}')" class="btn btn-xs btn-warning" >删除</a>
     </td>
         </tr>
    </c:forEach>
