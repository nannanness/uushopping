...
<div class="page-content clearfix">
 ...
 <div class="state-overview clearfix">
         ...
         <!-- <div class="Order_Statistics">
          <div class="title_name">用户登录统计信息</div>
           <table class="table table-bordered">
           <tbody>
           <tr><td class="name">注册用户登录：</td><td class="munber"><a href="#">3240</a>&nbsp;次</td></tr>
           <tr><td class="name">新浪用户登录：</td><td class="munber"><a href="#">1130</a>&nbsp;次</td></tr>
           <tr><td class="name">支付宝登录：</td><td class="munber"><a href="#">1130</a>&nbsp;次</td></tr>
           <tr><td class="name">QQ用户登录：</td><td class="munber"><a href="#">1130</a>&nbsp;次</td></tr>
           </tbody>
          </table>
         </div>  -->
             <!--<div class="t_Record">
 ...
 <div class="clearfix" style="margin-top:40px">
  <div class="home_btn">
     ...
     <a href="/pageJump/Category_Manage-business.do"  title="产品分类" class="btn  btn-primary btn-sm no-radius">
     ...
     <a href="/pageJump/Order_handling-business.do" title="商品订单" class="btn  btn-purple btn-sm no-radius">
