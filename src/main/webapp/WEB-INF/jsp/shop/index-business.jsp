...
<head>
	...
	<!-- <![endif]-->
	<!--[if IE]>
	<script type="text/javascript">window.jQuery || document.write("<script src='../resources/assets/js/jquery-1.10.2.min.js'>"+"<"+"script>");</script>
	<![endif]-->
...
//修改密码
            ...
            $('#Exit_system').on('click', function(){
                layer.confirm('是否确定退出系统？', {
                    ...
                    function(){
                        location.href="/pageJump/login-business.do";
			...
			<a href="#" class="navbar-brand">
				<small>
					<%--<img src="../resources/images/logo.png" width="470px">--%>
						<h2 style="line-height: 80px">UU购物店铺系统</h2>
				</small>
			</a><!-- /.brand -->
		</div><!-- /.navbar-header -->
...
<div class="main-container" id="main-container">
	...
	<div class="main-container-inner">
		...
		<div class="main-content">
			...
			<div class="breadcrumbs" id="breadcrumbs">
				<ul class="breadcrumb">
					<li>
						...
						<a href="/pageJump/index-business.do">首页</a>
					</li>
			...
			<iframe id="iframe" style="border:0; width:100%; background-color:#FFF;"name="iframe" frameborder="0" src="/pageJump/home-business.do">  </iframe>
