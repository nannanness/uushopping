...
<header id="pc-header">
    <div class="BHeader">
        <div class="yNavIndex">
            <ul class="BHeaderl">
                ...
                <li><a href="login.do" style="color:#ea4949;">请登录</a> </li>
    ...
    <div class="container clearfix">
        ...
        <div class="header-cart fr"><a href="my-d.do"><img src="theme/icon/car.png"></a> <i class="head-amount">0</i></div>
    ...
    <div class="yHeader">
        <div class="yNavIndex">
            <div class="pullDown">
                ...
                <ul class="pullDownList">
                    <li class="menulihover">
                        <i class="listi1"></i>
                        <a href="all-cl.do" target="_blank">家用电器</a>
                        <span></span>
                    </li>
                    <li>
                        <i class="listi2"></i>
                        <a href="all-class.do" target="_blank">手机、</a>
                        <a href="all-class.do" target="_blank">数码</a>
                        <span></span>
                    </li>
                    <li>
                        <i class="listi3"></i>
                        <a href="all-class.do" target="_blank">电脑、</a>
                        <a href="all-class.do" target="_blank">办公</a>
                        <span></span>
                    </li>
                    <li>
                        <i class="listi4"></i>
                        <a href="all-class.do" target="_blank">家居、</a>
                        <a href="all-class.do" target="_blank">家具、</a>
                        <a href="all-class.do" target="_blank">家装、</a>
                        <a href="all-class.do" target="_blank">厨具</a>
                        <span></span>
                    </li>
                    <li>
                        <i class="listi5"></i>
            ...
            <ul class="yMenuIndex">
                <li><a href="all-class.do" target="_blank">服装城</a></li>
                <li><a href="all-class.do" target="_blank">美妆馆</a></li>
                <li><a href="all-class.do" target="_blank">美食</a></li>
                <li><a href="all-class.do" target="_blank">全球购</a></li>
                <li><a href="all-class.do" target="_blank">闪购</a></li>
                <li><a href="all-class.do" target="_blank">团购</a></li>
                <li><a href="all-class.do" target="_blank">拍卖</a></li>
                <li><a href="all-class.do" target="_blank">金融</a></li>
                <li><a href="all-class.do" target="_blank">智能</a></li>
            </ul>
        </div>
    </div>
</header>
...
<div class="time-lists clearfix">
    <div class="time-list fl">
        <div class="time-title">
            ...
            <a href="sale-begin.do" class="fr">更多抢购商品</a>
        </div>
